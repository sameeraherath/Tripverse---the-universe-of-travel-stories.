        ...
        {popularTags.map(({ tag, count }) => {
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-1 px-3 py-1.5 rounded-full font-medium transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-md ${
                isSelected
